...
if(isset($_POST['valider'])){//bouton valider enclenché
    if(isset($_POST['dispo'], $_POST['heure'])){
      if($_POST['dispo']!='' && $_POST['heure']!='' ){
        ...
        $insertion = "INSERT INTO calendrier_2 (DateDispo) VALUES ('$dispo')";
        ...
        if($execute==true && $execute2==true){
          ...
          $msgError="Disponibilité déjà enregistré";
        }
      }
    }
  } 
...
<div id="corps">
    ...
    <form class='horaires' action='horaires.php' method='POST'>
      ...
      <input type="date" class="horaire-input" name="dispo" placeholder="JJ/MM/AAAA" required>(*)</br>
      ...
      $dispo=$bdd->query('SELECT E.DateDispo, HeureDispo FROM calendrier_2 C, etre_dispo E WHERE C.DateDispo=E.DateDispo');
      ...
      echo "</tr>\n";
        ...
        echo '</table>'."\n";// fin du tableau.
        ?>
        <input type='button' class='valid-button' name='delete' value='SUPPRIMER'>
    </form>  
